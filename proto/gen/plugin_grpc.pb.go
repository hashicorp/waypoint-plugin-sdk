...
type TaskLauncherClient interface {
	...
	StopSpec(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*FuncSpec, error)
	RunSpec(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*FuncSpec, error)
	...
	RunTask(ctx context.Context, in *FuncSpec_Args, opts ...grpc.CallOption) (*TaskRun_Resp, error)
}
...
func (c *taskLauncherClient) RunSpec(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*FuncSpec, error) {
	out := new(FuncSpec)
	err := c.cc.Invoke(ctx, "/hashicorp.waypoint.sdk.TaskLauncher/RunSpec", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskLauncherClient) RunTask(ctx context.Context, in *FuncSpec_Args, opts ...grpc.CallOption) (*TaskRun_Resp, error) {
	out := new(TaskRun_Resp)
	err := c.cc.Invoke(ctx, "/hashicorp.waypoint.sdk.TaskLauncher/RunTask", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTaskLauncherServer) RunSpec(context.Context, *emptypb.Empty) (*FuncSpec, error) {
...
func (UnimplementedTaskLauncherServer) RunTask(context.Context, *FuncSpec_Args) (*TaskRun_Resp, error) {
...
func _TaskLauncher_RunSpec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskLauncherServer).RunSpec(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hashicorp.waypoint.sdk.TaskLauncher/RunSpec",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskLauncherServer).RunSpec(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TaskLauncher_RunTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FuncSpec_Args)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskLauncherServer).RunTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hashicorp.waypoint.sdk.TaskLauncher/RunTask",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskLauncherServer).RunTask(ctx, req.(*FuncSpec_Args))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskLauncher_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RunSpec",
			Handler:    _TaskLauncher_RunSpec_Handler,
		},
		{
		...
		{
			MethodName: "RunTask",
			Handler:    _TaskLauncher_RunTask_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "plugin.proto",
