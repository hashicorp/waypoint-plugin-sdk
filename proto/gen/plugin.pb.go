...
type StatusReport struct {
	...
	TimeGenerated *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=time_generated,json=timeGenerated,proto3" json:"time_generated,omitempty"`
...
func (x *StatusReport) GetTimeGenerated() *timestamppb.Timestamp {
	if x != nil {
