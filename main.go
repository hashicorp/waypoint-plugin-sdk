...
//go:generate sh -c "protoc -I`go list -m -f \"{{.Dir}}\" github.com/hashicorp/protostructure` -I`go list -m -f \"{{.Dir}}\" github.com/hashicorp/opaqueany` -I ./thirdparty/proto/api-common-protos -I proto/ proto/*.proto --go_out=plugins=grpc:proto/gen/"
